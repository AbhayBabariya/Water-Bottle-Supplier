                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="dropdown dropdown-inline">
                            <asp:HyperLink ID="hlBranchAdd" runat="server" NavigateUrl="~/AdminPanel/Customer/CustomerAddEdit.aspx" CssClass="btn btn-primary btn-icon-sm"><i class="flaticon2-plus"></i> Add New</asp:HyperLink>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                    <div class="kt-input-icon kt-input-icon--left">
                                        <asp:TextBox runat="server" ID="txtMobileSerch" CssClass="form-control generalSearch" placeholder="Search Mobile No"></asp:TextBox>
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="gvCustomer" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover table-responsive-sm" OnRowCommand="gvCustomer_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <div style="text-align: center">
                                            <asp:HyperLink runat="server" ID="hlEdit" NavigateUrl='<%# "~/AdminPanel/Customer/CustomerAddEdit.aspx?CustomerID=" + Eval("CustomerID").ToString().Trim() %>'><i class="la la-edit"></i>Edit</asp:HyperLink>

                                            <asp:LinkButton ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-sm btn-clean btn-icon btn-icon-md" CommandName="DeleteRecord" CommandArgument='<%# Eval("CustomerID") %>'><i class="la la-trash"></i></asp:LinkButton>
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="CustomerName" HeaderText="Customer" />
                                <asp:BoundField DataField="MobileNo" HeaderText="Mobile No" />
                                <asp:BoundField DataField="Address" HeaderText="Address" ItemStyle-Width="220px" />
                                ...
                                <asp:BoundField DataField="Quantity" HeaderText="Quntity" ItemStyle-HorizontalAlign="Right" />
                                <asp:BoundField DataField="BottlePrice" HeaderText="Price" ItemStyle-HorizontalAlign="Right" />
                            </Columns>
                        </asp:GridView>
                        <br />
                    </div>
