<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel.master" AutoEventWireup="true" CodeFile="RegularOrderList.aspx.cs" Inherits="AdminPanel_RegularOrder_RegularOrderList" %>
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">List of Regular Order
                    </h3>
                </div>
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="dropdown dropdown-inline">
                            <asp:HyperLink ID="hlBranchAdd" runat="server" NavigateUrl="~/AdminPanel/RegularOrder/RegularOrderAddEdit.aspx" CssClass="btn btn-primary btn-icon-sm"><i class="flaticon2-plus"></i> Add New</asp:HyperLink>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="container">
                <div class="col-md-12">
                    <br />
                    <asp:GridView ID="gvRegularOrder" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover table-responsive-sm" OnRowCommand="gvRegularOrder_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <div style="text-align: center">
                                        <asp:HyperLink runat="server" ID="hlEdit" NavigateUrl='<%# "~/AdminPanel/RegularOrder/RegularOrderAddEdit.aspx?RegularOrderID=" + Eval("RegularOrderID").ToString().Trim() %>'><i class="la la-edit"></i>Edit</asp:HyperLink>

                                        <asp:LinkButton ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-sm btn-clean btn-icon btn-icon-md" CommandName="DeleteRecord" CommandArgument='<%# Eval("RegularOrderID") %>'><i class="la la-trash"></i></asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="BottlePrice" HeaderText="Bottle Price" ItemStyle-HorizontalAlign="Right" />
                            <asp:BoundField DataField="TotalAmount" HeaderText="Total Price" ItemStyle-HorizontalAlign="Right" />
