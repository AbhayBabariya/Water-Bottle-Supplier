...
/// <summary>
/// Summary description for RegularOrderDAL
/// </summary>
namespace WaterBottleSupplier.DAL
{
    public class RegularOrderDAL : RegularOrderDALBase
    {
            ...
            using (SqlConnection objConn = new SqlConnection(ConnectionString))
            {
                ...
                using (SqlCommand objCmd = objConn.CreateCommand())
                    try
                    {
                        #region Prepare Command
                        objCmd.CommandType = CommandType.StoredProcedure;
                        objCmd.CommandText = "PR_RegularOrder_SelectCustomerWiseSearchInvoice";
                        objCmd.Parameters.AddWithValue("@CustomerID", entRegularOrder.CustomerID);
                        objCmd.Parameters.AddWithValue("@FromDate", entRegularOrder.FromDate);
                        objCmd.Parameters.AddWithValue("@ToDate", entRegularOrder.ToDate);
                        #endregion Prepare Command
